...
# Multiple files
runar compile src/contracts/P2PKH.runar.ts src/contracts/Counter.runar.ts

# Glob pattern
runar compile src/contracts/*.runar.ts
```
...
runar compile src/contracts/Counter.runar.ts --disable-constant-folding --output ./build
```
...
- [Output Artifacts](/docs/compiler/output-artifacts) -- Understand the structure of compiled artifact files
- [How the Compiler Works](/docs/compiler/how-it-works) -- Architecture overview and design decisions
