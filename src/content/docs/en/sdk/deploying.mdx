...
This produces `artifacts/P2PKH.json`. See [Output Artifacts](/docs/compiler/output-artifacts) for a detailed explanation of the artifact format.
...
- [Calling a Contract](/docs/sdk/calling) -- How to spend the deployed contract UTXO
- [Stateful Contracts](/docs/sdk/inductive-contracts) -- Deploying and interacting with stateful contracts
- [Fee and Change Handling](/docs/sdk/fee-and-change-handling) -- Understanding fee estimation and UTXO selection
