...
Stateful contracts require special handling because the spending transaction must create a continuation output. See [Stateful Contracts](/docs/en/sdk/inductive-contracts) for the full guide. Here is a brief example:
...
- [Stateful Contracts](/docs/en/sdk/inductive-contracts) -- In-depth guide to stateful contract interactions
