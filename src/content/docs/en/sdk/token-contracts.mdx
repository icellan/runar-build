...
- [Stateful Contracts](/docs/sdk/inductive-contracts) -- The underlying pattern that tokens are built on
- [Fee and Change Handling](/docs/sdk/fee-and-change-handling) -- How fees work in token transactions
- [DAG Topology and Token Merges](/docs/advanced/dag-topology-and-token-merges) -- Advanced merge patterns
