...
```bash
runar compile src/contracts/MyContract.runar.ts --enable-constant-folding
```
...
- [Deploying a Contract](/docs/sdk/deploying) -- Deployment workflow including fee handling
- [Calling a Contract](/docs/sdk/calling) -- How fees are handled during method calls
- [Token Contracts](/docs/sdk/token-contracts) -- Fee considerations for token operations
