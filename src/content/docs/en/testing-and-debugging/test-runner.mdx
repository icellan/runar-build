...
Runar supports **eight** frontend languages (TypeScript, Go, Rust, Python, Zig, Ruby, Solidity, Move). The conformance test suite verifies that the same logical contract produces identical compiled output regardless of the source language. It works by comparing SHA-256 hashes of the compiled artifact against golden files:
