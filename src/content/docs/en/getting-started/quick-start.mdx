...
- Rúnar CLI installed (see [Installation](/docs/en/getting-started/installation))
...
- [Contract Basics](/docs/en/writing-contracts/contract-basics) -- Learn about data types, methods, and the contract lifecycle
- [Writing Tests](/docs/en/testing-and-debugging/writing-tests) -- Advanced testing patterns and utilities
- [StatefulSmartContract](/docs/en/sdk/overview) -- Build contracts that maintain state across transactions
