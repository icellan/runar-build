...
This matters for performance and for understanding gas/computation costs. Both branches always execute.
...
This produces a JSON artifact containing the compiled Bitcoin Script, the contract ABI (method signatures and parameter types), and metadata. See [Output Artifacts](/docs/en/compiler/output-artifacts) for details on the artifact format.
...
See [Writing Tests](/docs/en/testing-and-debugging/writing-tests) for a full testing guide.
...
- [Go Contracts](/docs/en/writing-contracts/go-contracts) -- Write contracts in Go
- [Language Feature Matrix](/docs/en/writing-contracts/language-feature-matrix) -- Compare all six languages
- [Writing Tests](/docs/en/testing-and-debugging/writing-tests) -- Test your contracts
