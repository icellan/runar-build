...
```bash
runar compile src/contracts/p2pkh.runar.rs --output ./artifacts
```
...
```bash
runar compile src/contracts/*.runar.rs --output ./artifacts
```
...
- [Python Contracts](/docs/writing-contracts/python-contracts) -- Write contracts in Python
