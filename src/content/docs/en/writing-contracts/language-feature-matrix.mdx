...
- [Contract Basics](/docs/en/writing-contracts/contract-basics) -- Core concepts that apply to all languages
- [TypeScript Contracts](/docs/en/writing-contracts/typescript-contracts) -- Start with the primary language
- [Compiler Configuration](/docs/en/compiler/configuration) -- Customize compilation for your language
