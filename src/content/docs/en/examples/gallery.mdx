...
### [Counter](/docs/en/examples/counter)
...
### [Auction](/docs/en/examples/auction)
...
### [Tic-Tac-Toe](/docs/en/examples/token-swap)
...
### [Blackjack Betting](/docs/en/examples/multi-sig-wallet)
...
### [Price Bet](/docs/en/examples/payment-channel)
...
Before diving into the examples, make sure you have completed the [tutorials](/docs/en/tutorials/hello-world), which cover the fundamentals: project setup, compilation, testing, and deployment.
