...
describe('PriceBet', () => {
  ...
  async function createBet() {
    ...
    return contract.create(alicePub, bobPub, oraclePubKey, strikePrice);
  }

  it('should allow mutual cancellation', async () => {
    const instance = await createBet();
  ...
  it('should reject cancel with only Alice signature', async () => {
    const instance = await createBet();
  ...
  it('should reject cancel with only Bob signature', async () => {
    const instance = await createBet();

    const result = await instance.call('cancel', {
      aliceSig: instance.sign(bobKey),
      bobSig: instance.sign(bobKey),
    });
