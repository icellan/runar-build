...
Now that you understand how UTXOs work, the next page covers [Bitcoin Script](/docs/en/bitcoin-bsv-basics/bitcoin-script) --- the low-level language that locking and unlocking scripts are written in, and the compilation target for all Runar contracts.
