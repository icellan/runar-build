...
With a solid understanding of how BSV smart contracts work at the protocol level, you are ready to start [Writing Contracts](/docs/writing-contracts/contract-basics) in Runar. The compiler and SDK handle the low-level details described on this page --- OP_PUSH_TX, state serialization, dispatch tables, and transaction construction --- so you can focus on your contract's business logic.
